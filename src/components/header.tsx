        ...
        <div className='flex items-center gap-4'>
          <div className='flex justify-center items-center w-8 h-8 bg-white'>
            <svg
              ...
              role='img'
              aria-label='Logotipo da AKAH'
            >
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M0 21.9852L3.46988 14.4933L9.37933 17.5257L0 21.9852Z'
                fill='url(#paint0_linear_47_125)'
              />
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M3.92419 13.5122L10.1824 0L12.4418 4.87568L9.27561 11.6541L17.6297 15.9649L20.454 22L10.5986 16.9459L3.92419 13.5122Z'
                fill='#201E1E'
              />
              <defs>
                <linearGradient
                  id='paint0_linear_47_125'
                  x1='8.43561'
                  y1='14.4933'
                  x2='0.943721'
                  y2='21.9852'
